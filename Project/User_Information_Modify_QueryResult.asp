...
<%
	...
	SQL = "Select * From User_Information Where 1 = 1"
	...
	If Session("UserName") <> "" Then
		SQL = SQL + " And 使用者名稱 Like '%" & Session("UserName") & "%'"
	End If

	If Session("UserNickname") <> "" Then
		SQL = SQL + " And 使用者ID Like '%" & Session("UserNickname") & "%'"
	End If
'	Response.Write SQL
'	Response.End
...
<body>
<p align="center"><b><font face="標楷體" size="5" color="#0000FF">修改使用者</font></b></p>
<%
...
Do While Not rs.EOF
	...
	Next
	Response.Write "<td><font color='#FFFFFF' size='2'><a href='User_Information_Modify.asp?UserMail=" & rs("使用者帳號") & "'>" & "Modify 修改" & "</font></td>"
	rs.Movenext
Loop
