...
<body>
<p align="center"><b><font face="標楷體" size="5" color="#0000FF">修改Open Device Information</font></b></p>
<%
...
Do While Not rs.EOF
	...
	Next
	Response.Write "<td><font color='#FFFFFF' size='2'><a href='Open_Device_Information_Modify.asp?ID=" & rs("ID") & "'>" & "Modify 修改" & "</font></td>"
	rs.Movenext
Loop
