...
<%
	...
	SQL = "Select * From Device_Information Where 1 = 1"
	
	If Session("DeviceName") <> "" Then
		SQL = SQL + " And 設備名稱 Like '%" & Session("DeviceName") & "%'"
	End If
...
<body>
<p align="center"><b><font face="標楷體" size="5" color="#0000FF">修改電子鎖</font></b></p>
<%
...
Do While Not rs.EOF
	...
	Next
	Response.Write "<td><font color='#FFFFFF' size='2'><a href='Device_Information_Modify.asp?DeviceID=" & rs("DeviceID") & "'>" & "Modify 修改" & "</font></td>"
	rs.Movenext
Loop
