...
<body>
<p align="center"><b><font face="標楷體" size="5" color="#0000FF">刪除電子鎖</font></b></p>
<%
...
Do While Not rs.EOF
	...
	Next
	Response.Write "<td><font color='#FFFFFF' size='2'><a href='Device_Information_Delete.asp?DeviceID=" & rs("DeviceID") & "'>" & "Delete 刪除" & "</font></td>"
	rs.Movenext
Loop
