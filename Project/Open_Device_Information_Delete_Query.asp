...
<p align="center"><font size="4" face="標楷體"><b>刪除Open Device Information</b></font></p>

	<form method="POST" action="Open_Device_Information_Delete_QueryResult.asp">
		<table style="width: 40%" align="center">
			<tr>
				<td><font SIZE="2">User ID</font></td>
				<td><font face="新細明體"><textarea rows="2" name="UserID" cols="32"></textarea></font></td>
			</tr>
			<tr>
